...
import 'package:liquid_swipe_gallery/liquid_swipe_gallery.dart';
import 'package:liquid_swipe_gallery/page_helpers/animated_page_dragger.dart';
...
class LiquidProvider extends ChangeNotifier {
  ...
  updateData(SlideUpdate event) {
    ...
    if (_slidePercentCallback != null &&
      ...
      int mod = event.direction == SlideDirection.leftToRight ? -1 : 1;
      String hor = (mod * event.slidePercentHor * 100).toStringAsExponential(2);
