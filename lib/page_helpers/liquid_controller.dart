...
/// Provides method for dynamic changes to the [LiquidSwipeGallery]
///
/// Simple Usage :
///
...
/// ```
///
/// Now simply add it to [LiquidSwipeGallery]'s Constructor
///
/// ```dart
///    LiquidSwipeGallery(
///         pages: pages,
...
///
/// So we have to use them after LiquidSwipeGallery is Built
///
///
class LiquidController {
  ...
  jumpToPage({required int page}) {
    assert(_provider != null,
        "LiquidController not attached to any LiquidSwipeGallery Widget.");
  ...
  ///If you want to disable gestures from start use [LiquidSwipeGallery.disableUserGesture]
